...
DESC_TITLE = ["Cute little swimming pool in the middle of the forest", "The best pool playground for all pet lovers!", "Quiet swimming pool retreat for busy people", "Fun urban pool with many toys available, come and have a look!", "The best pool in the city! Rent it before it's too late!", "Waterfall pool by the seaside, great night view", "Medium-sized pool for young and old, available now!", "Countryside garden pool to rent! Best seller!", "Comfortable and fun homestay, with a great pool!", "Amazing rooftop pool! Don't miss our cocktail maker!"]
...
CITIES = ["Berlin", "New York", "London", "Paris", "Monaco", "Marseille", "Shanghai", "Buenos Aires", "Madrid", "Lisbon"]
